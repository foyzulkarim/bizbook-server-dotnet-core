...
namespace B2BCoreApi.Controllers.CommandControllers.Sales
{
   ...
   //  using ServiceLibrary.Reports;
    ...
    [Route("api/Sale")]
    public class SaleController : BaseCommandController<M, Rm, Vm>
    {
        SaleService saleService;

        public SaleController(BizBookInventoryContext db, ILogger<SaleController> logger) : base(new SaleService(new BaseRepository<M>(db)), logger)
        {
