...
namespace B2BCoreApi.Controllers.QueryControllers.Sales
{
    ...
    public class SaleQueryController : BaseQueryController<M, Rm, Vm>
    {
        ...
        public SaleQueryController(BizBookInventoryContext db, ILogger<SaleQueryController> logger) : base(new Service(new BaseRepository<M>(db)), logger)
        {
        }
